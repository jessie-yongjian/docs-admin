...
在[componentsSettings](https://code.webtax.com.cn/webtax_income_tax/webtax_taxaudit_admin/src/settings/componentSetting.ts) 可以配置全局参数。用于统一整个项目的风格。可以通过 props 传值覆盖
